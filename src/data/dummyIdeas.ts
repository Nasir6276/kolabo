...
export const DUMMY_IDEAS: Idea[] = [
  {
    ...
    roles: [
      { id: "r1", title: "React Native Developer", isFilled: false },
      { id: "r2", title: "Backend Developer", isFilled: false },
      { id: "r3", title: "UI/UX Designer", isFilled: true },
      { id: "r4", title: "Logistics Lead", isFilled: true },
    ],
    postedBy: {
      name: "Amara O.",
  ...
  },
  {
    ...
    roles: [
      { id: "r1", title: "Data Scientist", isFilled: false },
      { id: "r2", title: "Fintech API Integration", isFilled: true },
      { id: "r3", title: "Product Designer", isFilled: true },
    ],
  ...
  },
  {
    ...
    roles: [
      { id: "r1", title: "Frontend Developer", isFilled: false },
      { id: "r2", title: "E-commerce/Payments Engineer", isFilled: false },
      { id: "r3", title: "Content Strategist", isFilled: false },
      { id: "r4", title: "Community Manager", isFilled: true },
      { id: "r5", title: "Backend Developer", isFilled: true },
    ],
    postedBy: {
      name: "Chiamaka N.",
  ...
  },
  {
    ...
    roles: [
      { id: "r1", title: "Mobile Developer", isFilled: false },
      { id: "r2", title: "Data Privacy/Security Advisor", isFilled: false },
      { id: "r3", title: "UX Researcher", isFilled: true },
      { id: "r4", title: "Psychology Advisor", isFilled: true },
    ],
    postedBy: {
      name: "David E.",
  ...
  },
  {
    ...
    roles: [
      { id: "r1", title: "Full-stack Developer", isFilled: false },
      { id: "r2", title: "Matching Algorithm Engineer", isFilled: false },
      { id: "r3", title: "UI/UX Designer", isFilled: false },
      { id: "r4", title: "Community Moderator", isFilled: false },
    ],
    postedBy: {
      name: "Zainab M.",
  ...
  },
  {
    ...
    roles: [
      { id: "r1", title: "Backend Developer", isFilled: false },
      { id: "r2", title: "Data Analyst", isFilled: true },
      { id: "r3", title: "Growth Marketer", isFilled: true },
    ],
